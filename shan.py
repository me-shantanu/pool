...
pygame.display.set_caption("Pool by @shan")
clock = pygame.time.Clock()

#define color for useed in code
background = (51,51,51)
white = (255,255,255)
gray =(128,128,128)
black = (0,0,0)
...
def game_start():
    ...
    image = pygame.image.load(r'bag.jpg')
